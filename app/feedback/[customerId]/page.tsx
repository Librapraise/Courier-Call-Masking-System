...
const translations = {
  he: {
    ...
    commentsLabel: 'האם יש משהו נוסף שתרצה שנדע? נשמח לקבל כל הערה, המלצה או הצעה לשיפור.',
  ...
  en: {
    ...
    commentsLabel: 'Is there anything you would like us to know? We would appreciate any comment, recommendation, or suggestion for improvement.',
    commentsPlaceholder: 'What could we improve, or what did you love?',
