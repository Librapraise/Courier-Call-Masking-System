...
const translations = {
  he: {
    ...
    commentsLabel: 'יש משהו שתרצה שנדע? נשמח לכל הערה, המלצה או הצעה לשיפור.',
  ...
  en: {
    ...
    commentsLabel: "Is there anything you'd like us to know? We'd be happy to receive any comments, recommendations, or suggestions for improvement.",
